...
NPM_COMMANDS = build build-types build-js dev benchmark benchmark-bun benchmark-node benchmark-deno setup clean reset prepack lint format prepublishOnly
